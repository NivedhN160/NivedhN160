...
def generate_svg():
    ...
    <g transform="translate(40, 40)">
        ...
        <text x="0" y="215">CONNECTION: <tspan class="highlight">SECURE</tspan></text>
        <text x="0" y="235">root@neural-grid</text>
        <text x="0" y="255">UPTIME: <tspan class="highlight">99.9%</tspan></text>
        
        <text x="0" y="295">repos: 56 | stars: 35 | followers: 13</text>
    </g>
    
    <!-- Console Output Section - tightly packed for real terminal look -->
    <g transform="translate(260, 45)">
        <text y="0">root@neural-grid:~# whoami</text>
        <text y="20">Nivedh Sunil</text>
        <text y="40">Backend AI Engineer &amp; OS Dev</text>
        
        <text y="80">root@neural-grid:~# cat philosophy.txt</text>
        <text y="100">I build things people assume already exist.</text>
        <text y="120">OS from bare metal. Transformers without ML frameworks.</text>
        <text y="140" class="highlight">OS for fun. AI for work.</text>
        
        <text y="180">root@neural-grid:~# ls -la ./projects</text>
        <text y="200">drwxr-xr-x 2 root root 4096 <tspan class="highlight">N-OS/</tspan>          # bare-metal OS</text>
        <text y="220">drwxr-xr-x 2 root root 4096 <tspan class="highlight">ZigNGPTv2.0/</tspan>   # transformer from scratch in Zig</text>
        <text y="240">drwxr-xr-x 2 root root 4096 <tspan class="highlight">Nexus/</tspan>         # personal AI ops platform</text>
        <text y="260">drwxr-xr-x 2 root root 4096 <tspan class="highlight">N.E.O.S/</tspan>       # agent shell</text>
        
        <text y="300">root@neural-grid:~# systemctl status nexus</text>
        <text y="320">● nexus.service — active (docker compose) | free-first | local LLM default</text>
        
        <text y="360">root@neural-grid:~# echo $STACK</text>
        <text y="380">[Python] [Zig] [C] [FastAPI]</text>
    </g>
</svg>"""
