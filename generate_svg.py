...
def generate_svg():
    ...
    # We use web-safe monospace fonts that render beautifully without external requests
    # GitHub blocks external Google Fonts in SVGs, so VT323 was failing and falling back to ugly Courier.
    svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="900" height="400">
    <defs>
        <style>
    ...
    <rect x="1" y="1" width="898" height="398" class="bg" />
    ...
    <g transform="translate(260, 45)">
        ...
        <text y="100" class="dim">I build things most people assume already exist.</text>
        <text y="120" class="dim">Operating systems from bare metal.</text>
        <text y="140" class="dim">Transformers without ML libraries.</text>
        <text y="160" class="highlight">Builds OSs for fun. Ships AI for work.</text>
        
        <text y="200">root@neural-grid:~# ls -la ./projects</text>
        <text y="220" class="dim">drwxr-xr-x 2 root root 4096 <tspan class="highlight">N-OS</tspan></text>
        <text y="240" class="dim">drwxr-xr-x 2 root root 4096 <tspan class="highlight">ZigNGPT</tspan></text>
        <text y="260" class="dim">drwxr-xr-x 2 root root 4096 <tspan class="highlight">LabMate</tspan></text>
        
        <text y="300">root@neural-grid:~# echo $STACK</text>
        <text y="320" class="dim">[Python] [Zig] [C] [FastAPI]</text>
    </g>
</svg>"""
